...
#define __GMP_CC "gcc"
#define __GMP_CFLAGS "-ggdb -O2 -pipe -Wimplicit-function-declaration -Wno-attributes -fdebug-prefix-map=/mnt/share/maint/gmp.x86_64/build=/usr/src/debug/gmp-6.1.2-1 -fdebug-prefix-map=/mnt/share/maint/gmp.x86_64/src/gmp-6.1.2=/usr/src/debug/gmp-6.1.2-1"
